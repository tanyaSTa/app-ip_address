 ...
 * @return {object} (firstIpAddress) - an object with two propertiess: ipv4 and ipv6.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  if (!cidr.isValid()) {
    ...
    [temp] = cidr.toArray(options);
    firstIpAddress.ipv4 = temp;
    firstIpAddress.ipv6 = getIpv4MappedIpv6Address(temp);
  }
